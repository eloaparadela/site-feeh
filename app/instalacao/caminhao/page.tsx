      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 lg:px-12 py-16 lg:py-24">
        ...
        <nav className="mb-10 text-sm theme-text-muted" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2">
            ...
            <li className="text-[#B4995A]">Rastreamento para Caminhão</li>
          </ol>
        </nav>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-16">
          <div className="lg:w-1/2">
            ...
            <h1 className="theme-text-primary text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Rastreamento para<br />
              <span className="text-[#B4995A]">Caminhão</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                href={`https://wa.me/5500000000000?text=${encodeURIComponent('Olá, gostaria de saber mais sobre o rastreamento para Caminhão.')}`}
          ...
          <div className="lg:w-1/2">
            <ImagePlaceholder text="Imagem caminhão com rastreador • 700×450" className="w-full rounded-lg" aspectRatio="16/10" dark={false} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            { title: 'Monitoramento 24h', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Seu caminhão protegido em tempo real.' },
            { title: 'Suporte especializado', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Equipe técnica disponível quando você precisar.' },
          ].map((b) => (
        ...
        <div className="text-center py-12 border theme-border-color rounded-xl theme-surface">
          <h2 className="theme-text-primary text-2xl font-bold mb-3">Pronto para proteger seu caminhão?</h2>
          <p className="theme-text-muted text-sm mb-6 max-w-md mx-auto">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Entre em contato e receba uma proposta personalizada.
          </p>
          <a href="/#orcamento" className="inline-flex items-center justify-center bg-[#B4995A] hover:bg-[#C8AF72] text-[#0F0A0F] font-bold px-8 py-4 rounded transition-colors">
            Ver planos — a partir de R$ 70,00/mês
          </a>
        </div>
      </div>
    </main>
