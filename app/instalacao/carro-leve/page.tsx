      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 lg:px-12 py-16 lg:py-24">
        ...
        <nav className="mb-10 text-sm theme-text-muted" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2">
            ...
            <li className="text-[#B4995A]">Rastreamento para Carro Leve</li>
          </ol>
        </nav>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-16">
          <div className="lg:w-1/2">
            ...
            <h1 className="theme-text-primary text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Rastreamento para<br /><span className="text-[#B4995A]">Carro Leve</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href={`https://wa.me/5500000000000?text=${encodeURIComponent('Olá, gostaria de saber mais sobre o rastreamento para Carro Leve.')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border border-[#B4995A]/30 hover:border-[#B4995A] theme-text-muted hover:text-[#B4995A] text-sm px-6 py-3 rounded transition-colors">Fale no WhatsApp</a>
            </div>
          </div>
          <div className="lg:w-1/2">
            <ImagePlaceholder text="Imagem carro leve com rastreador • 700×450" className="w-full rounded-lg" aspectRatio="16/10" dark={false} />
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            { title: 'Rastreador discreto', desc: 'Lorem ipsum dolor sit amet. Instalação profissional e invisível.' },
            { title: 'App completo', desc: 'Lorem ipsum dolor sit amet. Acompanhe tudo pelo celular em tempo real.' },
            { title: 'Alertas automáticos', desc: 'Lorem ipsum dolor sit amet. Notificações de ignição, cerca virtual e mais.' },
          ].map((b) => (
        ...
        <div className="text-center py-12 border theme-border-color rounded-xl theme-surface">
          <h2 className="theme-text-primary text-2xl font-bold mb-3">Pronto para proteger seu carro?</h2>
