        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-[40%] bg-[#0F0A0F] flex flex-col justify-center items-start p-8 lg:p-10 rounded-t-xl md:rounded-l-xl md:rounded-tr-none">
            ...
            <div className="relative w-full aspect-[7/5] rounded-lg overflow-hidden">
              <SmartImage
                src="/images/popup/ilustracao-veiculo-rastreado.jpg"
                alt="Ilustração de veículo rastreado"
                fill
                className="object-cover"
                placeholderText="Ilustração veículo rastreado • 280×200"
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full py-10 text-center">
                ...
                <p className="text-onyx/60 text-sm">
                  Em breve nossa equipe entrará em contato com sua cotação.
                </p>
                <button
                  onClick={close}
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                {/* Mensagem de erro */}
                {error && (
                  <p className="text-red-600 text-sm text-center mb-3" role="alert">
                    {error}
                  </p>
                )}
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-camel hover:bg-soft-fawn text-onyx font-bold text-sm py-4 px-6 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-camel disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {submitting ? 'Enviando…' : 'Quero uma cotação'}
                </button>
              </form>
            )}
          </div>
