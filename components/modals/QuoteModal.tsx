        ...
        <div className="px-6 py-6">
          {submitted ? (
            ...
            <div className="text-center py-10">
              ...
              <h3 className="text-white-smoke font-bold text-lg mb-2">Solicitação enviada!</h3>
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-camel hover:bg-soft-fawn text-onyx font-bold text-sm py-4 px-6 rounded transition-colors mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-camel disabled:opacity-60 disabled:cursor-not-allowed"
                >
