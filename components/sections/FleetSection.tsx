  ...
  return (
    <section id="frotas" aria-label="Soluções para frotas" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[42%] bg-white-smoke flex flex-col justify-center px-6 md:px-10 lg:px-14 xl:px-20 py-12 lg:py-16 order-2 lg:order-1">
          ...
          {/* Título */}
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-onyx leading-tight mb-5">
            {slide.title}
          </h2>
