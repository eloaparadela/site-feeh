  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[45%] bg-white-smoke dark:bg-onyx flex flex-col justify-center lg:justify-start px-6 md:px-10 lg:px-14 xl:px-20 py-12 lg:pt-0 lg:pb-16 order-2">
